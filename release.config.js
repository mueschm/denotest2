...
const github = [
  ...
  {
    "assets": [
      { "path": "./dist/windows/*", "name": "Windows", "label": "Windows" },
      { "path": "./dist/linux/*", "name": "Linux", "label": "Linux" },
      { "path": "./dist/osx-amd64/*", "name": "OSX AMD64", "label": "OSX AMD64" },
      { "path": "./dist/osx-arm64/*", "name": "OSX ARM64", "label": "OSX ARM64" },
    ]
  }
];
const changelog = [
